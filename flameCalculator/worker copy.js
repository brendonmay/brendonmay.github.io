onmessage = function (event) {
    const { start, end, item_level, flame_type, item_type, desired_stat, non_advantaged_item, maple_class, stat_equivalences } = event.data;

    // Your worker logic here

    // Example: Generate arrangements for the specified range
    const arrangements = generateArrangements(item_level, flame_type, item_type, desired_stat, non_advantaged_item, maple_class, stat_equivalences, start, end)
...
function generateArrangements(item_level, flame_type, item_type, desired_stat, non_advantaged_item, maple_class, stat_equivalences, start, end) {
