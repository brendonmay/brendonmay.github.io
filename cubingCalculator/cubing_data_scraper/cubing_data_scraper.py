...
DEFAULT_OUTPUT_PATH = os.path.join(DATA_DIR, "cubing_data")
DEFAULT_SOURCE_DATA_PATH = os.path.join(DATA_DIR, "source_data")
...
def parse_arguments():
    ...
    parser.add_argument('-o', '--output', metavar='dir', dest='output_dir', default=DEFAULT_OUTPUT_PATH,
                        help='Specify custom directory to save output cubing data to. '
                             'Otherwise, it will be saved to: {}'.format(DEFAULT_OUTPUT_PATH))

    return vars(parser.parse_args())


def main(output_dir):
    data_source_dir = DEFAULT_SOURCE_DATA_PATH
    ...
    dataformatter.format_cubing_data(raw_json_file, output_dir)
